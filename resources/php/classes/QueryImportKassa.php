...
$q = 'INSERT INTO '.$table.' (`nomer`,`data`, `iname`,`summa` ,`iorg_id`, `pr`,`mfo`)  values (';
foreach ($row as $key => $val){
if ( $key == 'FDOC_NUM'  OR $key == 'FDOC_DAT'  OR $key == 'FFIO' OR $key == 'FSUM' OR $key == 'FCL_COD1' OR $key == 'FCL_COD2'  ){ 
