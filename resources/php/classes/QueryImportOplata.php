...
$q = 'INSERT INTO '.$table.' (`nomer`,`data`, `iorg_id`, `iname`, `edrpou`,  `rs`, `summa` ,`note`,`mfo`,`pr`)  values (';
foreach ($row as $key => $val){
if ( $key == 'FDOC_NUM'  OR $key == 'FDOC_DAT'  OR $key == 'FORG' OR $key == 'FPR1' OR $key == 'FCOD_PR1'  OR $key == 'FFDB_SC' OR $key == 'FSUM' OR $key == 'FTOVAR' OR $key == 'FCOD_BNK2' OR $key == 'FCL2' ){ 
