...
//print($_sql);
 ...
 case "AppartmentChangeBti":
	...
	case "AppOtoplenieIns":
				 $this->sql='UPDATE YIS.OTOPLENIE SET zadol="'.$this->zadol.'",'
				 .'YIS.OTOPLENIE.metod="'.$this->metod.'",'
				.'YIS.OTOPLENIE.square="'.$this->square.'",'
				.'YIS.OTOPLENIE.gkal="'.$this->gkal.'",'
				.'YIS.OTOPLENIE.gkalm2="'.$this->gkalm2.'",'
				.'YIS.OTOPLENIE.gkm2="'.$this->gkm2.'",'
				.'YIS.OTOPLENIE.gkm2_mop="'.$this->gkm2_mop.'",'
				.'YIS.OTOPLENIE.gkal_mop="'.$this->gkal_mop.'",'
				.'YIS.OTOPLENIE.tarif="'.$this->tarif.'",'
				.'YIS.OTOPLENIE.tarif_gkal="'.$this->tarif_gkal.'",'
				.'YIS.OTOPLENIE.data_perer="'.$this->data_perer.'",'
				.'YIS.OTOPLENIE.tarif_perer="'.$this->tarif_perer.'",'
				.'YIS.OTOPLENIE.gkm2_perer="'.$this->gkal_old.'",'
				.'YIS.OTOPLENIE.gkm2_perer="'.$this->gkal_new.'",'				
				.'YIS.OTOPLENIE.perer_gkal="'.$this->perer_gkal.'",'
				.'YIS.OTOPLENIE.gkm2_perer="'.$this->gkm2_perer.'",'
				.'YIS.OTOPLENIE.perer="'.$this->perer.'",'
				.'YIS.OTOPLENIE.mop="'.$this->mop.'",'
				.'YIS.OTOPLENIE.otoplenie="'.$this->otoplenie.'",'
				.'YIS.OTOPLENIE.otoplenie_gkal="'.$this->otoplenie_gkal.'",'
				.'YIS.OTOPLENIE.nachisleno="'.$this->nachisleno.'",'
				.'YIS.OTOPLENIE.square_lg="'.$this->square_lg.'",'
				.'YIS.OTOPLENIE.budjet="'.$this->budjet.'",'
				.'YIS.OTOPLENIE.pbudjet="'.$this->pbudjet.'",'
				.'YIS.OTOPLENIE.budjet_mop="'.$this->budjet_mop.'",'
				.'YIS.OTOPLENIE.budjet_gkal="'.$this->budjet_gkal.'",'
				.'YIS.OTOPLENIE.budjet_m2="'.$this->budjet_m2.'",'
				.'YIS.OTOPLENIE.gkm2_lg="'.$this->gkm2_lg.'",'
				.'YIS.OTOPLENIE.square_lg="'.$this->square_lg.'",'
				.'YIS.OTOPLENIE.oplacheno="'.$this->oplacheno.'",'
				.'YIS.OTOPLENIE.dolg="'.$this->dolg.'",'
				.'YIS.OTOPLENIE.kzadol="'.$this->kzadol.'",'
				.'YIS.OTOPLENIE.kdolg="'.$this->kdolg.'",'
				.'YIS.OTOPLENIE.koplacheno="'.$this->koplacheno.'",'
				.'YIS.OTOPLENIE.knachisleno="'.$this->knachisleno.'",'
				.'YIS.OTOPLENIE.koplata="'.$this->koplata.'",'
				.'YIS.OTOPLENIE.info="'.$this->info.'",'
				.'YIS.OTOPLENIE.operator="'.$this->login.'",'
				.'YIS.OTOPLENIE.data_in= CURDATE() '
				.'WHERE YIS.OTOPLENIE.address_id='.$this->address_id.' AND YIS.OTOPLENIE.data = CONCAT(EXTRACT(YEAR_MONTH FROM "'.$this->data.'"),"01") LIMIT 1';
			    //print_r($this->sql); 
			break;
