 ...
 * Date: Tue Feb 02 2021 11:08:15 GMT+0200 (EET)
 *
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            handler: function(button, e) {
                                ...
                                var pbudjet = form.findField('pbudjet').getValue();
                                var oplacheno = form.findField('oplacheno').getValue();
                                var otoplenie_gkal = form.findField('otoplenie_gkal').getValue();
                                ...
                                if (tarif===0)  {
                                    ...
                                    otoplenie = gkal_add * tarif  ;
                                    otoplenie_gkal = gkal * tarif - budjet ;
                                    mop = gkal_mop * tarif - budjet_mop;
                                    gkm2 = gkal / square;
                                    gkm2_mop = gkal_mop / square;
                                    gkm2_add = gkal_add / square;

                                    nachisleno =otoplenie +otoplenie_gkal + mop + perer - pbudjet ;
                                    form.findField('gkm2').setValue(gkm2);
                                    form.findField('gkm2_mop').setValue(gkm2_mop);
                                    form.findField('gkm2_add').setValue(gkm2_add);
                                    form.findField('otoplenie').setValue(otoplenie);
                                    form.findField('otoplenie_gkal').setValue(otoplenie_gkal);
