 ...
 * Date: Mon Aug 03 2020 21:57:16 GMT+0300 (EEST)
 *
...
Ext.define('Ykis.view.flat.TabAppVodomer', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.tabappvodomer',

    requires: [
        'Ykis.view.flat.TabAppVodomerViewModel',
        'Ykis.view.flat.TabAppVodomerViewController',
        'Ext.form.Panel',
        'Ext.grid.Panel',
        'Ext.view.Table',
                            ...
                            },
                            {
                                ...
                                items: [
                                                ...
                                                items: [
                                                    {
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            ...
                                                            //GRID
                                                            var grVodomer = Ext.getCmp('grAppVodomer');
                                                            //FORMA
                                    ...
                                    },
                                    {
                                        ...
                                        text: 'Додати прилад обліку води'
                                    },
                                    {
                                        xtype: 'button',
                                                                        ...
                                                                        if(btn=='cancel'){
                                                                            ...
                                                                            QueryVodomer.newPokVodomera(value,function(data){
                                                                                if (data.success){
                                                                                    ...
                                                                                    fmVodomer.down('#newPokAppVod').setValue(0);
